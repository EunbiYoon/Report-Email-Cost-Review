...
msg.attach(MIMEText('<h3 style="font-family:sans-serif;">Dear Catalina,</h3><h4 style="font-family:sans-serif; font-weight:500">please let me know the item data is correct :)</h4>','html'))
